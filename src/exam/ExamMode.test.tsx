...
const initialQuestions: Question[] = [
  {
    ...
    correct_answer: "a",
    state_code: null,
    question_text_translation: "Q1_trans",
    explanation: "Exp1",
  },
  {
    id: "q2",
    ...
    correct_answer: "d",
    state_code: null,
    question_text_translation: "Q2_trans",
    explanation: "Exp2",
  },
];
...
jest.mock("./ExamTimer", () => () => (
  <div data-testid="exam-timer">Exam Timer Mock</div>
));
jest.mock(
  "./QuestionDisplay",
  () =>
...
jest.mock("./ExamNavigation", () => () => (
  <div data-testid="exam-navigation">Exam Navigation Mock</div>
));
...
describe("ExamMode - Submit Confirmation Popup", () => {
  ...
  test('clicking "Submit Exam" opens confirmation popup with correct unanswered count', () => {
    ...
    expect(
      screen.getByText(
        /You have 1 unanswered question\(s\). Are you sure you want to submit\?/,
      ),
    ).toBeInTheDocument();
  });
